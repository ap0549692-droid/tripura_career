...
<div class="flex min-h-screen">
    <aside class="w-64 bg-[#020617] text-white fixed left-0 top-0 bottom-0 z-50 hidden md:flex flex-col">
        ...
        <div class="flex-1 px-4 py-6 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-blue-600 text-white mb-2">
                <i class="fa-solid fa-gauge"></i><span>Dashboard</span>
            </a>
            <a href="<?php echo e(route('admin.jobs.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition mb-1">
                <i class="fa-solid fa-briefcase w-5"></i><span>Jobs</span>
            </a>
            <a href="<?php echo e(route('admin.scholarships.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition mb-1">
                <i class="fa-solid fa-graduation-cap w-5"></i><span>Scholarships</span>
            </a>
            <a href="<?php echo e(route('admin.admitCards.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition">
            ...
            <a href="<?php echo e(route('admin.jobs.create')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition mb-1">
                <i class="fa-solid fa-plus w-5"></i><span>Add Job</span>
            </a>
            <a href="<?php echo e(route('admin.scholarships.create')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition mb-1">
                <i class="fa-solid fa-plus w-5"></i><span>Add Scholarship</span>
            </a>
            <a href="<?php echo e(route('admin.admitCards.create')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition">
            ...
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-300 hover:bg-slate-800 hover:text-white transition">
        ...
        <div class="border-t border-slate-800 p-4">
            <div class="flex items-center gap-3 mb-4">
                ...
                <div class="min-w-0">
                    <p class="font-semibold text-sm truncate"><?php echo e(auth()->user()->name?? 'Admin'); ?></p>
                    <p class="text-xs text-slate-400 truncate"><?php echo e(auth()->user()->email?? 'admin@tripura.com'); ?></p>
                </div>
            </div>
    ...
    <main class="md:ml-64 w-full min-h-screen">
        <header class="bg-white border-b border-slate-200 px-6 md:px-8 py-5">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('home')); ?>" target="_blank" class="hidden sm:flex items-center gap-2 border border-slate-200 px-4 py-2.5 rounded-xl hover:bg-slate-50">
        ...
        <div class="p-5 md:p-8">
            ...
            <section class="rounded-2xl p-7 md:p-8 mb-7 bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h1 class="text-3xl md:text-4xl font-bold"><?php echo e(auth()->user()->name?? 'Admin'); ?> 👋</h1>
                        <p class="mt-2 text-blue-100">Here's what's happening on your portal today.</p>
                        
                        <div class="mt-6 flex flex-wrap gap-3">
                            <a href="<?php echo e(route('admin.autofetch')); ?>" class="bg-white text-blue-600 px-5 py-3 rounded-xl font-bold hover:bg-orange-100 transition shadow">
                                🔄 Fetch Jobs
                            </a>
                            <a href="<?php echo e(route('admin.autofetch.scholarship')); ?>" class="bg-white text-purple-600 px-5 py-3 rounded-xl font-bold hover:bg-purple-100 transition shadow">
                                🎓 Fetch Scholarships
                            </a>
                            <a href="<?php echo e(route('admin.autofetch.admitcard')); ?>" class="bg-white text-emerald-600 px-5 py-3 rounded-xl font-bold hover:bg-emerald-100 transition shadow">
                                🎫 Fetch Admit Cards
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <h3 class="text-4xl font-bold text-slate-900 mt-3"><?php echo e($jobCount); ?></h3>
                        </div>
                        <div class="w-12 h-12 rounded-xl bg-blue-100 text-blue-600 flex items-center justify-center">
                            <i class="fa-solid fa-briefcase text-xl"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(route('admin.jobs.index')); ?>" class="inline-block mt-6 text-sm font-semibold text-blue-600">Manage Jobs →</a>
                </div>
                <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm text-slate-500">Total Scholarships</p>
                            <h3 class="text-4xl font-bold text-slate-900 mt-3"><?php echo e($scholarshipCount); ?></h3>
                        </div>
                        <div class="w-12 h-12 rounded-xl bg-purple-100 text-purple-600 flex items-center justify-center">
                            <i class="fa-solid fa-graduation-cap text-xl"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(route('admin.scholarships.index')); ?>" class="inline-block mt-6 text-sm font-semibold text-purple-600">Manage Scholarships →</a>
                </div>
                <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-sm text-slate-500">Total Admit Cards</p>
                            <h3 class="text-4xl font-bold text-slate-900 mt-3"><?php echo e($admitCardCount); ?></h3>
                        </div>
                        <div class="w-12 h-12 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center">
                            <i class="fa-solid fa-id-card text-xl"></i>
                        </div>
                    </div>
                    <a href="<?php echo e(route('admin.admitCards.index')); ?>" class="inline-block mt-6 text-sm font-semibold text-emerald-600">Manage Admit Cards →</a>
                </div>
            </div>

            <h2 class="text-lg font-bold mb-4">Quick Actions</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
                <a href="<?php echo e(route('admin.jobs.create')); ?>" class="bg-white border border-slate-200 rounded-2xl p-5 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
                ...
                <a href="<?php echo e(route('admin.scholarships.create')); ?>" class="bg-white border border-slate-200 rounded-2xl p-5 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
                ...
                <a href="<?php echo e(route('admin.admitCards.create')); ?>" class="bg-white border border-slate-200 rounded-2xl p-5 flex items-center gap-4 hover:shadow-md hover:-translate-y-0.5 transition">
            ...
            <section class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                <div class="px-6 py-5 border-b border-slate-200 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.jobs.index')); ?>" class="text-sm font-semibold text-blue-600">View All</a>
                </div>
                    ...
                    <div class="divide-y divide-slate-100">
                        <?php $__currentLoopData = $recentJobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="px-6 py-5 flex items-center justify-between gap-4 hover:bg-slate-50">
                                <div class="min-w-0"><h3 class="font-semibold truncate"><?php echo e($job->title); ?></h3><p class="text-sm text-slate-500 mt-1"><?php echo e($job->department?? 'Government Department'); ?></p></div>
                                <a href="<?php echo e(route('admin.jobs.edit', $job->id)); ?>" class="text-blue-600 text-sm font-semibold">Edit</a>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\tripura-career\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>