...
<div class="max-w-4xl mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
        ...
        <div class="p-6">
            ...
            <form
                action="<?php echo e(route('admin.jobs.store')); ?>"
                method="POST"
            ...
            >
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        type="text"
                        name="location"
                        value="<?php echo e(old('location', 'Tripura')); ?>"
                    ...
                    >
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option
                                ...
                                <?php echo e(old('category', 'Government') == $category ? 'selected' : ''); ?>
                ...
                <div class="mb-5">
                    ...
                    >
                        ...
                        <?php $__currentLoopData = $qualifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qualification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option
                                value="<?php echo e($qualification); ?>"
                                <?php echo e(old('qualification', 'Graduate') == $qualification ? 'selected' : ''); ?>

                            >
                                <?php echo e($qualification); ?>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        type="date"
                        name="last_date"
                        value="<?php echo e(old('last_date')); ?>"
                        class="w-full border border-gray-300 p-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400"
                        required
                    >
...
<input name="syllabus_link" value="<?php echo e($job->syllabus_link?? ''); ?>" placeholder="Syllabus Link" class="border rounded-xl px-4 py-2 text-sm w-full">
<input name="pyq_link" value="<?php echo e($job->pyq_link?? ''); ?>" placeholder="PYQ Link" class="border rounded-xl px-4 py-2 text-sm w-full">
<input name="min_age" value="<?php echo e($job->min_age?? 18); ?>" placeholder="Min Age" class="border rounded-xl px-4 py-2 text-sm w-full">
<input name="max_age" value="<?php echo e($job->max_age?? 40); ?>" placeholder="Max Age" class="border rounded-xl px-4 py-2 text-sm w-full">
</div>
<textarea name="documents" placeholder="Documents comma separated" class="border rounded-xl px-4 py-2 text-sm w-full mt-3"><?php echo e($job->documents?? ''); ?></textarea>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        type="url"
                        name="apply_link"
                        value="<?php echo e(old('apply_link')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tripura-career\resources\views/admin/jobs/create.blade.php ENDPATH**/ ?>