...
async function sendAI(){
  ...
  try {
    // FIXED: route name se call, /api/ai-chat nahi
    ...
    document.getElementById('typing')?.remove();
    chat.innerHTML += `<div class="bg-white border rounded-2xl p-3 mr-6 text-red-500">Error: ${e.message} <br><a href='/jobs' class='text-blue-600 underline'>Browse Jobs</a></div>`;
    console.error(e);
  }
  chat.scrollTop = chat.scrollHeight;
}
